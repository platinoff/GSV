...
pub fn t(key: &str, lang: Lang) -> &'static str {
    match lang {
        ...
        Lang::Uk => match key {
            ...
            "action.reclaim" => "Повернути",
            "action.claiming" => "Беремо...",
            "action.doing" => "Завершуємо...",
            "action.erroring" => "Позначаємо помилку...",
            "action.reclaiming" => "Повертаємо...",
            "action.claimed" => "Взято",
            "action.done_ok" => "Готово",
            "action.error_ok" => "Помилку позначено",
            "action.reclaim_ok" => "Повернуто",
        ...
        Lang::Ru => match key {
            ...
            "nav.flows" => "Потоки",
            "nav.roles" => "Роли",
            "board.actions" => "Действия",
            "action.claim" => "Взять",
            "action.done" => "Готово",
            "action.error" => "Ошибка",
            "action.reclaim" => "Вернуть",
            "action.claiming" => "Берём...",
            "action.doing" => "Завершаем...",
            "action.erroring" => "Помечаем ошибку...",
            "action.reclaiming" => "Возвращаем...",
            "action.claimed" => "Взято",
            "action.done_ok" => "Готово",
            "action.error_ok" => "Ошибка помечена",
            "action.reclaim_ok" => "Возвращено",
            "status.open" => "Открыт",
            "status.in_progress" => "В работе",
            "status.done" => "Готово",
            "status.blocked" => "Заблокирован",
            "status.closed" => "Закрыт",
            "board.detail" => "Подробности",
