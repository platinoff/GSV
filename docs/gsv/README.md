...
| [`GSV_TECH_ROADMAP.md`](./GSV_TECH_ROADMAP.md) | **TechPreroadMap**: логічний порядок реалізації → future sprints (bands 102 · 108 · … · 127 VDT kit ✅) |
| [`GSV_VDT_KIT.md`](./GSV_VDT_KIT.md) | GSV як точка входу: shared rules/skills vs product canon (Accepted, band 127) |
| [`PRODUCTS.md`](./PRODUCTS.md) | Реєстр продуктів (`gsv` · `poolai`) для `абракадабра` |
