...
| **gsv_mcp_openbot** | `mcp.rs` + `gsv-mcp` bin | stdio + `GET`/`POST /mcp` + Galaxy card `/api/ui/card/mcp` | 26 box tools; клієнти: OpenCode / Cursor / Grok CLI / Grok Bot — [`GSV_MCP_OPENBOT.md`](./GSV_MCP_OPENBOT.md) |
