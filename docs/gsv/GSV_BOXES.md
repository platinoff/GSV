...
| **gsv_mcp_openbot** | `mcp.rs` + `gsv-mcp` bin | stdio + `GET`/`POST`/`DELETE /mcp` + Galaxy card `/api/ui/card/mcp` | 31 box tools + 8 `gsv://` resources (band 137–142 ✅ · **151 ✅** products/scan/watchdog/sw/fingerprints) — [`GSV_POST_ALWAYS_ON.md`](./GSV_POST_ALWAYS_ON.md) · [`GSV_MCP_OPENBOT.md`](./GSV_MCP_OPENBOT.md) |
