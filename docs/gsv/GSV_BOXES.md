...
| Settings | `settings/` (**band 166 queued**) | `/api/settings` | Godfather channel + redacted token + co-workflows; `data/gsv_settings.json` — [`GSV_SETTINGS_TELEGRAM.md`](./GSV_SETTINGS_TELEGRAM.md) |
