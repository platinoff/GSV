...
| Telegram walk sync | same telegram box (**band 175 ✅**) | MCP `gsv_tickets_walk` · `POST /api/tickets/walk` | solo claim/done + `{kind:sync}` envelopes |
