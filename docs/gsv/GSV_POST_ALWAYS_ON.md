...
**Status:** Landed (band **159** ✅ Cursor HTTP MCP + session SSE hold · band **158** ✅ live MCP stdio + sync check · band **156** ✅ streaming usage + VDT git + owner tunnel · band **155** ✅ session token usage · band **154** ✅ watchdog ops card + fingerprint model)  
**Date:** 2026-08-18  
