...
**Status:** Band 143 ✅ (chrome + type/chart); **band 144 ✅** (live copy + apply); **band 145 ✅** (products picker); 146–147 queued  
**Date:** 2026-08-17  
...
Next `абракадабра` on **gsv** drains **band 146** only (≤10 open PH-S*).
