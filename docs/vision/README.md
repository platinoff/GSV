...
> **GSV:** this folder is a **snapshot** for `gsv-vision-sync`. Live UI is `gsv-server` → `http://127.0.0.1:9999/`. Canon: [`../VISION.md`](../VISION.md) · [`../gsv/README.md`](../gsv/README.md) · [`../GSV_ROLES.md`](../GSV_ROLES.md) · [`../MEMORY.md`](../MEMORY.md). Legacy `vision.js`/`vision.css` stay as archive (band 117) and are not loaded.
