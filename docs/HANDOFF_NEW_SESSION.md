...
**Оновлено:** 2026-08-17 (band 140 `mcp_subscribe_notify` ✅)
...
(наступний band після 140). MCP canon: [`gsv/GSV_MCP_OPENBOT.md`](gsv/GSV_MCP_OPENBOT.md).
Канон ролей: [`GSV_ROLES.md`](GSV_ROLES.md). Реєстр: [`gsv/PRODUCTS.md`](gsv/PRODUCTS.md).

## Стан зараз

- **GSV** — окремий Rust-first проєкт (`S:\rust\GSV`), bands 102 · 108–121 · 125–139 · **140 ✅**.
...
- **Ratio / тести:** `gsv-loc-audit --stretch-96` → **96.32%** (rust 16807 / product 17449) · **310** green · clippy 0 · fmt clean.
- **Сервер:** canon порт **9999** (`DEFAULT_PORT`; 8765 — Hyper-V reserved range).
- **Vision rev:** **507** (band 140 `gsv-vision-sync`).
