//! GSV vision sync bin — mirrors `docs/vision/` into `data/`.
//!
//! Reads `docs/vision/manifest.json` + `docs/vision/feed.json` at the GSV
//! crate root and persists `data/gsv_manifest.json` + `data/gsv_feed.json`.
//!
//! ```text
