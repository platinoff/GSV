...
const RESOURCES: &[ResourceSpec] = &[
    ...
    ResourceSpec {
        ...
        description: "Band 167 Godfather bind landed; 168 tickets then 169 bus.",
        mime: "text/markdown",
