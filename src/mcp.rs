...
const RESOURCES: &[ResourceSpec] = &[
    ...
    ResourceSpec {
        ...
        description: "Band 186: federated join, Git worktrees, Telegram caps, per-server MCP jail.",
        mime: "text/markdown",
