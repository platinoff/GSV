...
const RESOURCES: &[ResourceSpec] = &[
    ...
    ResourceSpec {
        ...
        description: "Band 186: federated join, Git worktrees, Telegram caps, per-server MCP jail. Band 187: live getChatMemberCount fills member_count.",
        mime: "text/markdown",
