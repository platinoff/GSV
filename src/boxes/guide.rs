...
pub const CARD_GUIDE: &[GuideEntry] = &[
    ...
    GuideEntry {
        ...
        group: "ops",
        r#use: "work board",
        blurb: "Claim, walk, hook (roadmap / plan / GitHub issues), next-action inbox, federated jail presence, and Godfather kind:claim / kind:done / kind:reclaim on the host board.",
    },
    GuideEntry {
        id: "update",
        title: "Update",
