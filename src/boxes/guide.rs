...
pub const CARD_GUIDE: &[GuideEntry] = &[
    ...
    GuideEntry {
        ...
        blurb: "Telegram channel, bot token (redacted), jail id, and squad cap.",
    },
    GuideEntry {
        id: "telegram",
        title: "Telegram",
        group: "ops",
        r#use: "channel bind",
        blurb: "Bind and poll the Godfather channel. Tickets and bus land here.",
    },
    GuideEntry {
        id: "tickets",
        title: "Tickets",
        group: "ops",
        r#use: "work board",
        blurb: "Claim, walk, hook, and next-action inbox for solo or squad MCP bots.",
    },
    GuideEntry {
        id: "update",
        title: "Update",
        group: "ops",
        r#use: "swap live bin",
        blurb: "Apply a rebuilt binary. The page goes offline only during the swap.",
    },
    GuideEntry {
        id: "tracker",
        title: "Tracker",
